...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN", "7465921121:AAETC2AokVr_XvUFLPEMthuN_OFf2wDeI3A")
	BOT_USERNAME = os.environ.get("BOT_USERNAME", "Testing_developer11_bot")
	...
	DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Hshshssh:ehejsjs@cluster0.rnl2vwv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
